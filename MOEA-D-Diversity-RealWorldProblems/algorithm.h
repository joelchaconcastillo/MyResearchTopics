...
//	sprintf(filename,"/home/joel.chacon/Chacon/Tesis/Novel_Special_Decomposition_Algorithms/optimized/vsd-moead-opt/ParameterSetting/Weight/W%dD_%d.dat", nobj, pops);
	sprintf(filename,"/home/joel.chacon/Chacon/Tesis/Novel_Special_Decomposition_Algorithms/optimized/vsd-moead-opt-real-problems/ParameterSetting/Weight/W%dD_%d.dat", nobj, pops);
...
//		real_sbx_xoverB(population[plist[0]].indiv,population[plist[1]].indiv, child);
		...
		//rate2=1.0;
		//HBX(population[c_sub].indiv,population[plist[0]].indiv,population[plist[1]].indiv, child, rate2);
...
//		{
//			cout << child_pop[i].x_var[0] << " " << child_pop[i].x_var[1] << " | "<<population[i].indiv.x_var[0] << " " << population[i].indiv.x_var[1] << " | "<< best[i].x_var[0] << " " << best[i].x_var[1] << endl;
//		}
//		getchar();
		//update_memory();
}
...
//	max_gen = int(5.0*300000/pops);
	...
	sprintf(filename1,"/home/joel.chacon/Chacon/Tesis/Novel_Special_Decomposition_Algorithms/optimized/vsd-moead-opt-real-problems/POS/POS_MOEAD_%s_RUN%d_seed_%d.dat_bounded",strTestInstance,run, seed);
	sprintf(filename2,"/home/joel.chacon/Chacon/Tesis/Novel_Special_Decomposition_Algorithms/optimized/vsd-moead-opt-real-problems/POF/POF_MOEAD_%s_RUN%d_seed_%d.dat_bounded",strTestInstance,run, seed);
...
//  sprintf(filename,"/home/joel.chacon/Chacon/Tesis/Novel_Special_Decomposition_Algorithms/VSD_MOEA_D_Cubic/backup_vsd_moead_crowding/ParameterSetting/%s.txt", strTestInstance);
	sprintf(filename,"/home/joel.chacon/Chacon/Tesis/Novel_Special_Decomposition_Algorithms/optimized/vsd-moead-opt-real-problems/ParameterSetting/%s.txt", strTestInstance);
