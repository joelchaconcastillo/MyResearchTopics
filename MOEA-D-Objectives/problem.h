...
void dtlz1(vector<double> &F, vector<double> &X)
{
...
void dtlz2(vector<double> &F, vector<double> &X)
{
...
void dtlz3(vector<double> &F, vector<double> &X)
{
  int numberOfVariables_ = X.size();
  int numberOfObjectives_ = F.size();
...
void dtlz4(vector<double> &F, vector<double> &X)
{
...
void dtlz5(vector<double> &F, vector<double> &X)
{
  double g = 0.0;
  int numberOfVariables_ = X.size();
  int numberOfObjectives_ = F.size();
...
void dtlz6(vector<double> &F, vector<double> &X)
{
  double g = 0.0;
  int numberOfVariables_ = X.size();
  int numberOfObjectives_ = F.size();
...
void dtlz7(vector<double> &F, vector<double> &X)
{
  double g = 0.0;
  int numberOfVariables_ = X.size();
  int numberOfObjectives_ = F.size();
