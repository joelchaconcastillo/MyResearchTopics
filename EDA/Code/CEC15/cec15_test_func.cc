...
void cec15_test_func(double *x, double *f, int nx, int mx,int func_num)
{
    ...
    if (ini_flag==0)
    {
        ...
        /* Load Matrix M*/
        sprintf(FileName, "/home/joel.chacon/Chacon/DE_diversity/Parametrization_CEC15/Case1/input_data15/M_%d_D%d.txt", func_num,nx);
        ...
        if (cf_num>1)
        {
            sprintf(FileName, "/home/joel.chacon/Chacon/DE_diversity/Parametrization_CEC15/Case1/input_data15/bias_%d.txt", func_num);
            fpt = fopen(FileName,"r");
            if (fpt==NULL)
            {
                printf("\n Error: Cannot open input file for reading \n");
        ...
        /* Load shift_data */
        sprintf(FileName, "/home/joel.chacon/Chacon/DE_diversity/Parametrization_CEC15/Case1/input_data15/shift_data_%d.txt", func_num);
        fpt = fopen(FileName,"r");
        if (fpt==NULL)
        {
            printf("\n Error: Cannot open input file for reading \n");
        ...
        {
            sprintf(FileName, "/home/joel.chacon/Chacon/DE_diversity/Parametrization_CEC15/Case1/input_data15/shuffle_data_%d_D%d.txt", func_num, nx);
            fpt = fopen(FileName,"r");
            if (fpt==NULL)
            {
                printf("\n Error: Cannot open input file for reading \n");
