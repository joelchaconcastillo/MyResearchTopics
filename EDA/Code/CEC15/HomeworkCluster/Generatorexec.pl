...
chomp $Path;
#my $Path = "/home/joel.chacon/Chacon/DE_diversity/Parametrization_CEC15/Case1/";
my $Instance=0;
my $Sed=0;
...
foreach(@Dimension)
{
	for( my $problem= 1; $problem <=15; $problem++) ##Realizar 35 ejecuciones con distintas semilla de cada instancia..
	{
