algname=(GDE3 MOEA_D_DE MOEA_D_SBX NSGAII_SBX NSGAII_DE Proposal_SBX Proposal_DE SMS_EMOA_SBX)
##Calculating the HV considering plus 10% for each objective
   cont=0
for alg in GDE3/POF MOEA_D/DE/POF MOEA_D/SBX/POF NSGAII/SBX/POF NSGAII/DE/POF Proposal/SBX/POF Proposal/DE/POF SMS-EMOA/SBX/POF
do
