...
#POF_MOEAD_DTLZ7_RUN3_seed_26_nobj_3.dat_bounded
   #mv *_${instance}_*seed_${sed}_nobj_2.dat_bounded ${instance}_2_${sed}
   cat POF/*_${instance}_*seed_${sed}_nobj_2.dat_bounded | awk '{print $1" "$2}'> POF/${instance}_2_${sed}
   done
done
...
#OBJ_GD3_CROSS_SELECTON_DIFERENTAL_EVALUATIONS_250000_WFG9_SEED_34.txt_3obj
   cat POF/*_${instance}_*seed_${sed}_nobj_3.dat_bounded | awk '{print $1" "$2" "$3}'> POF/${instance}_3_${sed}
